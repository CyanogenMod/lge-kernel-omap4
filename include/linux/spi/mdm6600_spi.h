...
#define MODEM_GPIO_RESET		142
#define MODEM_GPIO_PWRON		22

#define IFX_SPI_MAX_BUF_SIZE		3020	/* Max buffer size */
#define IFX_SPI_DEFAULT_BUF_SIZE	3020 	/* Default buffer size*/
#define IFX_SPI_HEADER_SIZE		4
#define SPI_MAX_PACKET_LEN		3024		/* Defined for SPI packet validity check */
