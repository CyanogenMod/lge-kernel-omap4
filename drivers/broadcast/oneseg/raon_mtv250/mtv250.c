...
#endif
	DMBERR("[mtv250_read][DtvReadTS] In\n");
	if(count == 0)
	{
...
read_fail:	
	...
	DMBERR("[mtv250_read][DtvReadTS] Out\n");
	return ret;
}
...
#endif
{
	...
	switch( cmd )
	{
		case IOCTL_ISDBT_POWER_ON: // with adc clk type
			DMBMSG("[mtv][DtvStart]IOCTL_ISDBT_POWER_ON In\n");
			...
			DMBMSG("[mtv][DtvStart]IOCTL_ISDBT_POWER_ON Out\n");
			break;

		case IOCTL_ISDBT_POWER_OFF:
			DMBMSG("[mtv][DtvEnd] In IOCTL_ISDBT_POWER_OFF In\n");
			mtv250_power_off();
			DMBMSG("[mtv][DtvEnd] In IOCTL_ISDBT_POWER_OFF Out\n");
			break;

		case IOCTL_ISDBT_SCAN_FREQ:
			DMBMSG("[mtv][DtvFastSearch] In\n");
			DMBMSG("[mtv] ISDBT SCAN Frequency In");
			...
			DMBMSG("[mtv][DtvFastSearch] Out\n");
			break;
			
		case IOCTL_ISDBT_SET_FREQ:
			DMBMSG("[mtv][DtvSetFrequency] In\n");
			if (copy_from_user(&isdbt_ch_num, argp, sizeof(UINT)))
			{
				ret = -EFAULT;
				goto IOCTL_EXIT;
			...
			DMBMSG("[mtv][DtvSetFrequency] Out\n");
			break;		

		case IOCTL_ISDBT_GET_LOCK_STATUS:
			DMBMSG("[mtv][DtvGetState] In\n");
		...
		case IOCTL_ISDBT_GET_SIGNAL_INFO:
			DMBMSG("[mtv][DtvGetSignalInfo] In\n");
			...
			DMBMSG("[mtv][DtvGetSignalInfo] Out\n");
			break;	

		case IOCTL_ISDBT_LGE_GET_TUNER_INFO:
			DMBMSG("[mtv][DtvGetTunerInfoLGE] In\n");
			DMBMSG("[mtv][DtvGetTunerInfoLGE_v2] In\n");
			...
			DMBMSG("[mtv][DtvGetTunerInfoLGE] Out\n");
			DMBMSG("[mtv][DtvGetTunerInfoLGE_v2] Out\n");
			break;

		case IOCTL_ISDBT_START_TS:
			DMBMSG("[mtv][ISDB-T][DtvStartTS] In\n");
			RTV_GUARD_LOCK;
			mtv250_cb_ptr->start_ts_int_cnt = 0;
			mtv250_cb_ptr->ovf_err_cnt = 0;
			mtv250_cb_ptr->max_read_jiffies = 0;
			rtv_StreamEnable();
			RTV_GUARD_FREE;
			DMBMSG("[mtv][ISDB-T][DtvStartTS] Out\n");
			break;

		case IOCTL_ISDBT_STOP_TS:
			DMBMSG("[mtv][ISDB-T][DtvStopTS] In\n");
			rtvISDBT_DisableStreamOut();
			mtv250_reset_tsp();
			DMBMSG("[mtv][ISDB-T][DtvStopTS] Out\n");
			break;
...
{
	DMBMSG("[mtv250_open][DtvStart] In called\n");
	...
	mtv250_tsp_queue.cnt = 0;
#endif
	DMBMSG("[mtv250_open][DtvStart] Out\n");
	return 0;
}
