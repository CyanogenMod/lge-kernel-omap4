...
static bool cleanup_flag = FALSE;	//by sjpark 11-10-19
...
#endif /* DHDTHREAD */
	if(cleanup_flag == TRUE)	//by sjpark 11-10-19
	{
...
dhd_module_cleanup(void)
{
	...
	cleanup_flag = TRUE;	//by sjpark 11-10-19
...
#if defined(CONFIG_LGE_BCM432X_PATCH) /* after dhd_bus_register */
	/* Call customer gpio to turn on power with WL_REG_ON signal */
	dhd_customer_gpio_wlan_ctrl(WLAN_POWER_ON);
#endif
