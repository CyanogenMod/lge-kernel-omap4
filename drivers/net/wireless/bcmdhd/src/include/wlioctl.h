 ...
 *
 * $Id: wlioctl.h 322836 2012-03-22 00:56:49Z $
 */
...
typedef struct {
	...
	uint32	mcs[WL_HISTO_SZ_HT_MCS * WL_TX_CHAINS_MAX];	/* MCS counts */
	uint32	vht[WL_HISTO_SZ_VHT_MCS][WL_TX_CHAINS_MAX];	/* VHT counts */
