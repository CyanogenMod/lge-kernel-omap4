...
static struct mdm_watcher_platform_data p940_mdm_watcher_pdata __refdata = {
	.event = mdm_watcher_event_data,
	.len = ARRAY_SIZE(mdm_watcher_event_data),
};

static struct platform_device p940_mdm_watcher_device __refdata = {
...
lge_machine_initcall(p940_pdevs_init);
