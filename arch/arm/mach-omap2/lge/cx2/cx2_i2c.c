...
int touch_power_control(int on)
{
	...
	gpio_set_value(GPIO_TOUCH_RESET, on);
#endif
...
#ifdef CONFIG_MACH_LGE_CX2 //nthyunjin.yang 120412
...
TWL6030_REGULATOR_DEVICE(vaux2, 2800000, 2800000, 1, 1);	// TWL_LDO_2.8V  //Soojong.jin Temporary Change
TWL6030_REGULATOR_DEVICE(vaux3, 1800000, 1800000, 1, 1);	// TWL_DO_1.8V   //Soojong.jin Temporary Change
#else
...
static struct twl4030_madc_platform_data p720_gpadc_data = {
	.irq_line = 1,
};

static int p720_batt_table[] = {
...
static struct twl4030_bci_platform_data p720_bci_data = {
	.monitoring_interval = 10,
	.max_charger_currentmA = 1500,
	.max_charger_voltagemV = 4560,
	.max_bat_voltagemV = 4200,
	.low_bat_voltagemV = 3300,
	.battery_tmp_tbl = p720_batt_table,
	.tblsize = ARRAY_SIZE(p720_batt_table),
};
...
static struct regulator_init_data p720_clk32kg = {
	.constraints = {
		.valid_ops_mask = REGULATOR_CHANGE_STATUS,
...
static struct twl4030_platform_data p720_twldata = {
	...
	.clk32kg = &p720_clk32kg,
	.madc = &p720_gpadc_data,
	.bci = &p720_bci_data,
 ...
 */
#if defined(CONFIG_TOUCHSCREEN_P940_GENERAL)
static struct p720_synaptics_platform_data p720_ts_data = {
	.gpio = GPIO_TOUCH_IRQ,
...
static struct mpu3050_platform_data mpu3050_data = {
	.int_config = 0x10,
#ifdef CONFIG_MACH_LGE_CX2 //hongkeon.kim 2012-0503
	.orientation = {
		1, 0, 0,
		0, 1, 0,
		0, 0, 1
...
/* LGE_CHANGE [jaejoon.park@lge.com]
 * add PN544(NFC) I2C configuration 2011-03-22
 */
...
//#ifdef CONFIG_MACH_LGE_CX2_P720
	...
	if (system_rev <= LGE_PCB_EVB) {
		...
		p720_twldata.regen2 = &twl6030_regen2_data;
	}
#endif
...
#ifdef CONFIG_MACH_LGE_CX2 //nthyunjin.yang p2720 remove for len - 4 
#if defined(CONFIG_MHL_TX_SII9244) || defined(CONFIG_MHL_TX_SII9244_LEGACY)
	/* LGE_SJIT 2011-12-15 [choongryeol.lee@lge.com] 
	 * After revision C, MHL doesn't use HW I2C */
//	if (system_rev >= LGE_PCB_C) {
		/* remove last 4 array which is for MHL data */
		i2c_2_config.len = i2c_2_config.len - 4;
//	}
#endif
#endif
	...
	((struct pn544_i2c_platform_data *)i2c_2_info[2].platform_data)->
	    firm_gpio =
	    (system_rev >= fixed_rev) ? NFC_GPIO_FRIM_HW_1_X : NFC_GPIO_FRIM;
#endif
