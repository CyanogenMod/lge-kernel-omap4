...
//---
#if CONFIG_MACH_LGE_CX2 //##hwcho_20120416
#include <plat/keypad.h>
#endif

#if CONFIG_MACH_LGE_CX2 //nthyunjin.yang 120412
...
#if CONFIG_MACH_LGE_CX2 //nthyunjin.yang 120421
...
static struct mdm_watcher_platform_data p720_mdm_watcher_pdata __refdata = {
	.event = mdm_watcher_event_data,
	.len = ARRAY_SIZE(mdm_watcher_event_data),
};

static struct platform_device p720_mdm_watcher_device __refdata = {
	.name = MDM_WATCHER_NAME,
	.id = -1,
	.dev  = {
		.platform_data = &p720_mdm_watcher_pdata,
	},
};
//LGE_TELECA_RIL_RECOVERY_CP_RESET_6  -END
...
static struct key_table gkpd_keys[] = {
	{'D', KEY_VOLUMEDOWN},
	{'U', KEY_VOLUMEUP},
#if defined(CONFIG_MACH_LGE_CX2)//hw2002.cho
	{'F', KEY_3D},
#else
	{'F', KEY_CAPTURE},
#endif //##
...
static struct platform_device cx2_fuel_gauge_device= {
	.name		= "max17043_gpio",
	.id		= -1,
...
// LGE_SJIT_E 09/28/2011 [mohamed.khadri@lge.com] Enabled GPS Related configuration
	...
	&keypad_led,
	&charger_device,
#ifdef CONFIG_MACH_LGE_CX2 //nthyunjin.yang 120420
	&cx2_fuel_gauge_device,
#endif
	//+++LG_BTDRV hyuntae0.kim@lge.com (2011-03-24): 
	&bcm4330_device,
//BEGIN: 0018892 hyuntae0.kim@lge.com 2011-5-18
...
//LGE_TELECA_RIL_RECOVERY_CP_RESET_6  -START
//20110505, ravi.holal@teleca.com, RIL RECOVERY
//Description: Adding the p720_mdm_watcher_device structure to platform	
	&p720_mdm_watcher_device,
//LGE_TELECA_RIL_RECOVERY_CP_RESET_6  -END	
...
int __init p720_pdevs_init(void)
{
	...
	if (system_rev <= LGE_PCB_EVB) {
		...
		keypad_led_pdata.hold_key_gpio = 43;
	}
	else if (system_rev <= LGE_PCB_A) {
		keypad_led_pdata.keypad_gpio = 142;
		keypad_led_pdata.hold_key_gpio = 53;
	}
	else {
...
lge_machine_initcall(p720_pdevs_init);
