...
/* Correct mux setting to optimize standby current */
	...
	/* Bluetooth GPIO Mux */
	LGE_MUX_GPIO(GPIO_BT_RESET, OMAP_PIN_OUTPUT),
	LGE_MUX_GPIO(GPIO_BT_WAKE, OMAP_PIN_OUTPUT),
	LGE_MUX_GPIO(GPIO_BT_HOST_WAKE, OMAP_WAKEUP_EN | OMAP_PIN_INPUT_PULLDOWN),
